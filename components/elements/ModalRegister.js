...
export default function ModalRegister({ isRegister, handleRegister }) {
	return (
		<>
					...
					<div className="modal-content">
						<div className="flat-account bg-surface">
							...
							<form action="#">
								...
								<div className="mt-12 text-variant-1 text-center noti">Already have an account?<Link href="#modalLogin" data-bs-toggle="modal" className="text-black fw-5">Login Here</Link> </div>
							</form>
						</div>
					</div>
				</div>
