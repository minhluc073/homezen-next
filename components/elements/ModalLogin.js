...
export default function ModalLogin({ isLogin, handleLogin }) {
	return (
		<>
					...
					<div className="modal-content">
						<div className="flat-account bg-surface">
							...
							<form action="#">
								...
								<div className="mt-12 text-variant-1 text-center noti">Not registered yet?<Link href="#modalRegister" data-bs-toggle="modal" className="text-black fw-5">Sign Up</Link> </div>
							</form>
						</div>
					</div>
				</div>
